<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ClassPartsQuiz.aspx.cs" Inherits="Labs_ClassExample" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <asp:Label ID="lblFind" runat="server" Text="Find the: " Font-Size="Large" 
        Font-Bold="True" ForeColor="Black"></asp:Label>

<asp:Label ID="lblClassPart" runat="server" ForeColor="Blue" Font-Size="Large" 
        Text=" " Font-Bold="True"></asp:Label>
<asp:Literal ID="Literal1" runat="server"><p/></asp:Literal>
<asp:Label ID="lblselected" runat="server" ForeColor="Black" Text="Selection: " 
        Font-Size="Large" Font-Bold="True" CssClass="indent150"></asp:Label>
<asp:Label ID="lblselectedvalue" runat="server" ForeColor="Black" Text="" Font-Size="Large" Font-Bold="True"></asp:Label>
<asp:Label ID="lblCorrect" ForeColor="Black" runat="server" Text=" " 
        Font-Size="Large" Font-Bold="True" CssClass="indent10"></asp:Label>
<asp:Literal ID="Literal2" runat="server"><p/></asp:Literal>

<asp:Label ID="lblSessionStats" runat="server" ForeColor="Black" Text="Current Stats" 
                Font-Size="Large" Font-Bold="True" CssClass="indent150"></asp:Label>
                

<asp:Label ID="lblWrong" ForeColor="Black" runat="server" Text="Incorrect" Font-Size="Large" Font-Bold="True" CssClass="indent10"></asp:Label>
<asp:Label ID="lblWrongCount" runat="server" Text="0" Font-Size="Large" Font-Bold="True" 
                    ForeColor="#CC0000" CssClass="indent10"></asp:Label>

<asp:Label ID="lblRight" runat="server" Text="Correct" ForeColor="Black" Font-Size="Large" Font-Bold="True" CssClass="indent10"></asp:Label>
<asp:Label ID="lblRightCount" runat="server" Text="0" Font-Size="Large" Font-Bold="True" 
                    ForeColor="#006600" CssClass="indent10"></asp:Label>


<asp:Label ID="lblCorrectInRow" runat="server" Text="Consecutive Correct" ForeColor="Black" 
                Font-Size="Large" Font-Bold="True" CssClass="indent10"></asp:Label>
<asp:Label ID="lblCorrectInRowCount" runat="server" Text="0" Font-Size="Large" Font-Bold="True" 
                        ForeColor="#006600" CssClass="indent10"></asp:Label>
<asp:Literal ID="Literal4" runat="server"><p/></asp:Literal>
